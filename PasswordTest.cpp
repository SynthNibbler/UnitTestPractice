...
TEST(PasswordTest, repeatedLower_case_password)
{
	Password my_password;
	ASSERT_EQ(2, my_password.count_leading_characters("aab"));
}

TEST(PasswordTest, patternedMix_case_password)
{
	Password my_password;
	ASSERT_EQ(1, my_password.count_leading_characters("FfF"));
}


TEST(PasswordTest, manyRepeated_case_password)
{
	Password my_password;
